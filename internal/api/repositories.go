...
func (a *API) listRepos(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		writeError(w, r, http.StatusInternalServerError, "failed to list repositories", err.Error())
		return
	}
...
func (a *API) createRepo(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		writeError(w, r, http.StatusInternalServerError, "failed to create repository", err.Error())
		return
	}
...
func (a *API) getRepo(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		writeError(w, r, http.StatusNotFound, "repository not found", err.Error())
		return
	}
...
func (a *API) updateRepo(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		writeError(w, r, http.StatusInternalServerError, "failed to update repository", err.Error())
		return
	}
...
func (a *API) deleteRepo(w http.ResponseWriter, r *http.Request) {
	...
	if err := a.repoQueries.Delete(r.Context(), repoID); err != nil {
		writeError(w, r, http.StatusInternalServerError, "failed to delete repository", err.Error())
		return
	}
...
func (a *API) listFiles(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		writeError(w, r, http.StatusInternalServerError, "failed to list files", err.Error())
		return
	}
...
func (a *API) createFile(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		writeError(w, r, http.StatusInternalServerError, "failed to create file", err.Error())
		return
	}
	...
	if len(req.Content) > 0 {
		...
		if err != nil {
			writeError(w, r, http.StatusInternalServerError, "failed to create file version", err.Error())
			return
		}
	}
...
func (a *API) getFile(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		writeError(w, r, http.StatusNotFound, "file not found", err.Error())
		return
	}
...
func (a *API) listFileVersions(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		writeError(w, r, http.StatusInternalServerError, "failed to list file versions", err.Error())
		return
	}
...
func (a *API) listCommits(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		writeError(w, r, http.StatusInternalServerError, "failed to list commits", err.Error())
		return
	}
...
func (a *API) createCommit(w http.ResponseWriter, r *http.Request) {
	...
	if req.AuthorID == "" {
		writeError(w, r, http.StatusBadRequest, "author_id is required", "")
		return
	}
	...
	if err != nil {
		writeError(w, r, http.StatusInternalServerError, "failed to create commit", err.Error())
		return
	}
...
func (a *API) getCommit(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		writeError(w, r, http.StatusNotFound, "commit not found", err.Error())
		return
	}

	files, err := a.commitQueries.GetCommitFiles(r.Context(), commitID)
	if err != nil {
		writeError(w, r, http.StatusInternalServerError, "failed to get commit files", err.Error())
		return
	}
...
func (a *API) getCommitValidations(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		writeError(w, r, http.StatusInternalServerError, "failed to get validation summary", err.Error())
		return
	}
